...
export class Path extends THREE.Group {
    ...
    constructor(parentObj, index, checkpointFloating, checkpointGrounded, URorigin){
        super();

        this.eventEmitter = new EventEmitter();

        this.URorigin = URorigin;
    ...
    updatePathData(){
        ...
        this.pathData.checkpoints.forEach(checkpoint => {
            ...
            if (checkpoint.name === this.selectedCheckpoint.name){
                ...
                this.URorigin.worldToLocal(selectedLocal);

                // TODO: change coordinates for UR
                let posXUR = selectedLocal.x;
                let posYUR = selectedLocal.y;
                let posZUR = selectedLocal.z;
                ...
                checkpoint.posXUR = posYUR;
                checkpoint.posYUR = -posXUR;
                checkpoint.posZUR = posZUR;
                checkpoint.orientation = this.selectedCheckpoint.getOrientation();

                //console.log('NEW UR POS: ', posXUR, posYUR, posZUR);
            }
        });

        if (!exists){

            // Change coordinates for UR
            ...
            console.log('Position CP in GP: ', selectedLocal);
