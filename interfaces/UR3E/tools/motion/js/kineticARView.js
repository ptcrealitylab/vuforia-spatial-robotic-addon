...
export class KineticARView extends EventEmitter{
    constructor(){
        ...
        */
        ...
        this.fanuc_dummy = new THREE.Object3D();
        let fanuc_model = new THREE.Object3D();
        let occurrence_of_J5J6 = new THREE.Object3D();
        let occurrence_of_J2J3 = new THREE.Object3D();
        let occurrence_of_J1J2 = new THREE.Object3D();
        let occurrence_of_J3J4 = new THREE.Object3D();
        let occurrence_of_J4J5 = new THREE.Object3D();
        let occurrence_of_BaseJ1 = new THREE.Object3D();
        let occurrence_of_J6End = new THREE.Object3D();
            ...
            ( gltf ) => {
                ...
                gltf.scene.traverse(function (child) {
                    ...
                    if (child.name === 'occurrence_of_J5J6'){
                        occurrence_of_J5J6 = child;
                    }

                    if (child.name === 'occurrence_of_J2J3'){
                        occurrence_of_J2J3 = child;
                    }
                    if (child.name === 'occurrence_of_J1J2'){
                        occurrence_of_J1J2 = child;
                    }

                    if (child.name === 'occurrence_of_J3J4'){
                        occurrence_of_J3J4 = child;
                    }
                    if (child.name === 'occurrence_of_BaseJ1'){
                        occurrence_of_BaseJ1 = child;
                    }
                    if (child.name === 'occurrence_of_J6End'){
                        occurrence_of_J6End = child;
                    }
                    if (child.name === 'occurrence_of_J4J5'){
                        occurrence_of_J4J5 = child;
                    }

                });

                this.scene.add(fanuc_model);
                fanuc_model.scale.set(200, 200, 200);
                this.robotDummy.attach(fanuc_model);
                fanuc_model.position.set(0,0,0);
                fanuc_model.rotation.set(0,0,0);
                //fanuc_model.rotateX(-90);
                
                console.log(fanuc_model);

                this.fanuc_dummy = fanuc_model;

                /*
                this.scene.add(occurrence_of_J5J6);
                //occurrence_of_J5J6.scale.set(100, 100, 100);

                this.scene.add(occurrence_of_J2J3);
                //occurrence_of_J2J3.scale.set(100, 100, 100);

                this.scene.add(occurrence_of_J1J2);
                //occurrence_of_J1J2.scale.set(100, 100, 100);

                this.scene.add(occurrence_of_J3J4);
                //occurrence_of_J3J4.scale.set(100, 100, 100);

                this.scene.add(occurrence_of_BaseJ1);
                //occurrence_of_BaseJ1.scale.set(100, 100, 100);

                this.scene.add(occurrence_of_J6End);
                //occurrence_of_J6End.scale.set(100, 100, 100);

                this.scene.add(occurrence_of_J4J5);
                //occurrence_of_J4J5.scale.set(100, 100, 100);

                this.robotDummy.attach(occurrence_of_J5J6);
                this.robotDummy.attach(occurrence_of_J2J3);
                this.robotDummy.attach(occurrence_of_J1J2);
                this.robotDummy.attach(occurrence_of_J3J4);
                this.robotDummy.attach(occurrence_of_BaseJ1);
                this.robotDummy.attach(occurrence_of_J6End);
                this.robotDummy.attach(occurrence_of_J4J5);
                */
                ...
                occurrence_of_BaseJ1.attach(occurrence_of_J1J2);
                occurrence_of_J1J2.attach(occurrence_of_J2J3);
                occurrence_of_J2J3.attach(occurrence_of_J3J4);
                occurrence_of_J3J4.attach(occurrence_of_J4J5);
                occurrence_of_J4J5.attach(occurrence_of_J5J6);
                occurrence_of_J5J6.attach(occurrence_of_J6End);*/
            },
            ( xhr ) => {
    ...
    */
    ...
    anchorRobotToGroundPlane(){
        ...
        this.groundPlaneContainerObj.attach(this.dummy_anchor)
