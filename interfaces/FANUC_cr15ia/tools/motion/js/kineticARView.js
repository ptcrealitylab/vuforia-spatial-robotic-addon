...
export class KineticARView extends EventEmitter{
    ...
    */
    ...
    anchorRobotToGroundPlane(){
        ...
        // 55 cm / 2 = 27.5 cm - 3.2 cm = 24.3 cm   --> this is relative to the actual dimensions of the FANUC robot

        this.dummy_anchor.translateX(243);
        this.dummy_anchor.translateY(243);
        this.dummy_anchor.translateZ(610);
    ...
    */
    ...
    checkpointTriggered(idx){
        if (idx === 0) this.currentPath.resetCheckpoints(); // We reset the checkpoints to origin state
