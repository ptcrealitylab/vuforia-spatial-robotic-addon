...
export class Checkpoint extends THREE.Group {
    ...
    generateHexLabel(index){
        ...
        this.hexPlane.rotateY(Math.PI/2);
        ...
        this.planeNumber.rotateY(Math.PI/2);
    ...
    resetColor(){
        this.checkpointMesh.material.uniforms.u_color.value.setHex(0x00d4d2);   // blue
    }

    activateNextAnimation(){
        this.checkpointMesh.material.uniforms.u_color.value.setHex(0x00ff44);   // green
        this.goalAnim = true;
    }

    deactivateNextAnimation(){
        this.checkpointMesh.material.uniforms.u_color.value.setHex(0x4400ff);   // purple
        this.goalAnim = false;
    }

    update(){

        // Footprint rotation is only implemented for AGVs. No rotation for robotic arms yet
        /*
